...
public class AdministrationView extends VLayout {

    private TabSet mainTabSet;
    private AdminSideNavTree sideNav;
...
//                    tab.setTitle("<span>" + imgHTML + "&nbsp;" + sampleName + "</span>");
    ...
    public void onHistoryChanged(String historyToken) {
        if (historyToken == null || historyToken.equals("")) {
            ...
            ExplorerTreeNode[] showcaseData = sideNav.getConfigData();
