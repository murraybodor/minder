...
public class OtherDocTypeView extends ConfigurationAbstractView {

    public static class Factory implements PanelFactory {
        private String id;

        public Canvas create() {
        	OtherDocTypeView panel = new OtherDocTypeView();
            id = panel.getID();
            return panel;
        }
	...
	public Canvas getViewPanel() {
		...
		listGrid.setDataSource(Cache.getOtherDocTypeDataSource());
