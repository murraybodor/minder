...
public class SupervisorsView extends ConfigurationAbstractView {

    public static class Factory implements PanelFactory {
        private String id;

        public Canvas create() {
        	SupervisorsView panel = new SupervisorsView();
            id = panel.getID();
            return panel;
        }
	...
	public Canvas getViewPanel() {
		...
		listGrid.setDataSource(Cache.getSupervisorsDataSource());
