...
public class VehicleTypeView extends ConfigurationAbstractView {

    public static class Factory implements PanelFactory {
        private String id;

        public Canvas create() {
        	VehicleTypeView panel = new VehicleTypeView();
            id = panel.getID();
            return panel;
        }
	...
	public Canvas getViewPanel() {
		...
		listGrid.setDataSource(Cache.getVehTypeDataSource());
