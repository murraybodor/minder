...
public class ArrivalsManifestReportView extends ReportAbstractView {

    public static class Factory implements PanelFactory {
        private String id;

        public Canvas create() {
        	ArrivalsManifestReportView panel = new ArrivalsManifestReportView();
            id = panel.getID();
            return panel;
        }
	...
	public ArrivalsManifestReportView() {
	}
	...
	public Canvas getViewPanel() {
		...
		Label parmLabel1 = new Label("Arrivals Manifest Report Parm 1");
