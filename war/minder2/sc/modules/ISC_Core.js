...
*/
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'minder2/sc/';}
...
,isc.A.updateViewport=function isc_c_Page_updateViewport(_1,_2,_3,_4){var _5=[];if(_1!=null)_5[_5.length]=("initial-scale="+_1);if(_2!=null)_5[_5.length]=("width="+_2);if(_3!=null)_5[_5.length]=("height="+_3);if(_4!=null)_5[_5.length]=("user-scalable="+(_4==false?"no":"yes"));_5=_5.join(", ");var _6=document.getElementsByTagName("meta"),_7;for(var i=_6.length-1;i>=0;i--){if(_6[i].name=="viewport"){_7=_6[i];_7.parentNode.removeChild(_7);_7=null}}
...
,isc.A.$l3=function isc_c_EventHandler__handleDragScroll(){var _1=this,_2=_1.dragTarget;if(_1.dragOperation==_1.DRAG_SCROLL)return;var _3=[];var _4=_2.dragScrollType=="parentsOnly"?_2.getParentElements():isc.Canvas._canvasList;;if(_4==null||_4.length==0)return;for(var i=0;i<_4.length;i++){if((_4[i].hscrollOn||_4[i].vscrollOn)&&_4[i].isDrawn()&&_4[i].isVisible()&&_4[i].shouldDragScroll()){_3.add(_4[i])}}
...
);isc.evalBoundary;isc.B.push(isc.A.$l7=function isc_c_EventHandler__canAccessNativeTargetProperties(_1){try{if(!(isc.Browser.isMoz&&_1==this.$jm))return true;_1.parentNode}catch(e){return false}
return true}
...
);isc.evalBoundary;isc.B.push(isc.A.maskTarget=function isc_c_EventHandler_maskTarget(_1,_2){return this.maskTargets(_1,_2)}
...
);isc.B._maxIndex=isc.C+168;isc.EventHandler.captureEvents();if("2010.10.02_09.35.33"!=""&&!"2010.10.02_09.35.33".startsWith("${")&&!window.isc_expirationOff&&new Date()>Date.parseStandardDate("2010.10.02_09.35.33"))
...
isc.ClassFactory.defineClass("Element",null,null,true);isc.A=isc.Element;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$wq=window.isc_insertAfterBodyStart;isc.A.$wr="isc_global_insertion_marker";isc.A.$n7="afterBegin";isc.A.$n9="afterEnd";isc.A.$n6="beforeBegin";isc.A.$n8="beforeEnd";isc.A.$w2=isc.Browser.isMoz?"border-left-width":"borderLeftWidth";isc.A.$w3=isc.Browser.isMoz?"border-top-width":"borderTopWidth";isc.A.$oi=isc.Browser.isMoz?"margin-left":"marginLeft";isc.A.$ok=isc.Browser.isMoz?"margin-top":"marginTop";isc.A.$27r="none";isc.A.$nk={};isc.A.$419={border:"borderStyle",borderWidth:"borderStyle",borderLeft:"borderLeftStyle",borderRight:"borderRightStyle",borderTop:"borderTopStyle",borderBottom:"borderBottomStyle",borderLeftWidth:"borderLeftStyle",borderRightWidth:"borderRightStyle",borderBottomWidth:"borderBottomStyle",borderTopWidth:"borderTopStyle"};isc.A.$nl={};isc.A.$39=";";isc.A.vendorCSSPrefix=(isc.Browser.isMoz?"-moz-":isc.Browser.isSafari?"-webkit-":isc.Browser.isOpera?"-o-":"");isc.B.push(isc.A.get=function isc_c_Element_get(_1,_2){_2=_2||this.getDocument();if(isc.Browser.isDOM)return _2.getElementById(_1)}
...
);isc.evalBoundary;isc.B.push(isc.A.clearHandle=function isc_Canvas_clearHandle(){if(!this.getHandle())return;this.$p6("clears");this.getHandle().eventProxy=null;this.getClipHandle().eventProxy=null;var _1=this.getClipHandle();this.$q3=null;this.$rs=null;this._clipDiv=null;isc.Element.clear(_1,this._clearWithRemoveChild)}
...
{_1.dragTarget=this;_1.dragOperation=_1.DRAG_SCROLL;_1.dragAppearance=_1.NONE}else if(this.canDrag){_1.dragTarget=this;_1.dragOperation=_1.DRAG}}}
...
);isc.evalBoundary;isc.B.push(isc.A.peerDrawn=function isc_Canvas_peerDrawn(_1){}
...
);isc.evalBoundary;isc.B.push(isc.A.$wl=function isc_Canvas__getCornerImage(_1){return isc.Img.urlForState(this.cornerClipImage,null,null,this.cornerClipColor,_1)}
...
var _5=this.dataProperties||{};if(this.dataFetchDelay)_5.fetchDelay=this.dataFetchDelay;isc.addProperties(_5,{operation:_2,filter:_1,context:_3,componentId:this.ID});if(this.sortField||this.$73p){if(!this.$73p){var _6=!isc.isAn.Array(this.sortField)?[this.sortField]:this.sortField;this.$73p=isc.DS.getSortSpecifiers(_6)}
_5.$73p=this.$73p;_5.$39x=isc.DS.getSortBy(_5.$73p)}else if(this.initialSort){this.$73p=isc.shallowClone(this.initialSort);_5.$73p=this.$73p;_5.$39x=isc.DS.getSortBy(_5.$73p)}
...
,isc.A.getCleanRecordData=function isc_Canvas_getCleanRecordData(_1){if(isc.ResultTree&&isc.isA.ResultTree(this.data)){return this.data.getCleanNodeData(_1,false)}
...
,isc.A.addDetailedExportFieldValue=function isc_Canvas_addDetailedExportFieldValue(_1,_2,_3,_4,_5,_6){var _7=_4.name;var _8=this.getRecordHiliteCSSText(_3,null,_4);if(_4.userSummary==null){if(_8){var _9=this.convertCSSToProperties(_8,_6);if(_9)_1[_2]=_9}
return}
if(!_4.userSummary.text)this.logError("Summary field does not have text format");var _10=[],_11={},_12={};var _13=(_8&&_8!="");for(var _14 in _4.userSummary.summaryVars){var _15=_4.userSummary.summaryVars[_14],_16=this.getField(_15);if(!_16)_10.add(_15);else{_11[_14]=_16;var _17=this.getRecordHiliteCSSText(_3,null,_16);if(_17){_12[_14]=_17;_13=true}}}
if(!_13)return;if(_10.length!=0&&_8){_1[_2]=this.convertCSSToProperties(_8,_6);return}
var _18=null,_19=null,_20=[];var _21=this;var _22=function(_33,_34){if(_33){_33=_21.htmlUnescapeExportFieldValue(_33);if(_18&&_19==_34){_18.value+=_33}else{if(_18)_20.push(_18);_18={value:_33};_19=_34;if(_34)_18.style=_21.convertCSSToProperties(_34,_6)}}};var _23=_4.userSummary.text.split("#"),_24=/^\{([A-Z]+)\}/;if(_23[0])_22(_23[0],_8);for(var i=1;i<_23.length;i++){var _26=_23[i],_27,_28,_29,_30,_31,_32;_29=_26.charAt(0);_28=_11[_29];if(_28)_32=_26.substr(1);else if(_27=_26.match(_24)){_32=_26.substr(_27[0].length);_29=_27[1];_28=_11[_29];if(_28)_32=this.missingSummaryFieldValue+_32}else _32="#"+_26;if(_28){_30=this.getExportFieldValue(_3,_28.name,this.getFieldNum(_28.name));_31=null;if(_8)_31=(_31||"")+_8;if(_12[_29])_31=(_31||"")+_12[_29]}
_22(_30,_31);_22(_32,_8)}
if(_18)_20.push(_18);_1[_2]=_20}
...
_2=_3}}
return _2}
,isc.A.getRecordExportObject=function isc_Canvas_getRecordExportObject(_1,_2,_3,_4,_5){var _6={};for(var _7=0;_7<_2.length;_7++){var _8=_2[_7];if((!this.fields.contains(_8))&&!_4)continue;var _9=this.getFieldNum(_8.name),_10=this.htmlUnescapeExportFieldTitle(_8.title||_8.name),_11=_10+"$style";var _12=this.getExportFieldValue(_1,_8.name,_9);if(_12==null||_12=="&nbsp;")_12="";_6[_10]=_12;this.addDetailedExportFieldValue(_6,_11,_1,_8,_9,_3)}
return _6}
...
);isc.B._maxIndex=isc.C+11;isc.ApplyAutoTestMethods=function(){isc.Canvas.addClassMethods({getCanvasLocatorFallbackPath:function(_9,_39,_155,_156,_157){if(_156==null)_156={};if(_157==null)_157={};else if(isc.isAn.Array(_157)){var _1={};for(var i=0;i<_157.length;i++){_1[_157[i]]=_157[i]}
_157=_1}
if(_157.title==null)_157.title="title";if(_157.scRole==null)_157.scRole="waiRole";if(_157.name==null)_157.name="name";var _3=_39.getClassName(),_4=_39.getClass();_156.Class=_3;var _5;if(!_4.isFrameworkClass){_5=_4.$750}
if(_5!=null)_156.scClass=_5;if(_155!=null){_156.index=_155.indexOf(_39);_156.length=_155.length;var _6=_155.findAll("Class",_3);_156.classIndex=_6.indexOf(_39);_156.classLength=_6.length;if(_5!=null){var _7=_155.findAll("$75y",_5);_156.scClassIndex=_7.indexOf(_39);_156.scClassLength=_7.length}
if(_39.waiRole!=null){var _8=_155.findAll("waiRole",_39.waiRole);_156.roleIndex=_8.indexOf(_39);_156.roleLength=_8.length}}
return isc.AutoTest.getObjectLocatorFallbackPath(_9,_39,_156,_157)},getCanvasFromFallbackLocator:function(_155,_43,_44,_45,_46){var _9=_43.name;var _10=_43.Class,_5=_43.scClass||_43.Class,_11=_43.scRole;switch(_45){case"name":if(_9!=null){var _12=_44.find("name",_9);if(_12){switch(_46){case"Class":if(_10&&isc.isA[_10]&&isc.isA[_10](_12)){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching name and ClassName:"+_12,"AutoTest")}
return _12}
case"scClass":if(_5&&isc.isA[_5]&&isc.isA[_5](_12))
{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching name and scClassName:"+_12,"AutoTest")}
return _12}
case"role":var _13=_43.scRole;if(_12.waiRole==_13){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching name and role:"+_12,"AutoTest")}
return _12}
default:if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_155+". Returning closest match:"+_12+". This has the same name "+"as the recorded component but does not match class or role. ","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching name:"+_12,"AutoTest")}}
return _12}}}
...
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching name and scClassName:"+_16,"AutoTest")}
return _16}}}
case"role":if(_11){var _17=_15.findAll("waiRole",_11);if(_17!=null){if(_17.length==1||_16==null)
_16=_17[0];if(_17.length==1&&_16){if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching title and role:"+_16,"AutoTest")}
return _16}}}
default:if(_15.length==1){if(_46!="none"){isc.AutoTest.logRobustLocatorWarning();this.logWarn("Locator string:"+_155+". Returning closest match:"+_15[0]+". This has the same title "+"as the recorded component but does not match class or role.","AutoTest")}else{if(this.logIsDebugEnabled("AutoTest")){this.logDebug("Locator string:"+_155+" - returning widget with matching title:"+_16,"AutoTest")}}
return _15[0]}else{this.logWarn("Locator string:"+_155+", attempt to match by title failed -- multiple candidate components have this "+"same title. Attempting to match by index instead.","AutoTest")}}}}
default:var _18,_19,_20;switch(_46){case"Class":if(_10&&_43.classIndex){var _21=_44.findAll("Class",_10);if(_21&&_21.length>0){_18=_21[parseInt(_43.classIndex)];if(_21.length==parseInt(_43.classLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_155+" - returning widget with matching ClassName / index by ClassName:"+_18,"AutoTest")}
return _18}}}
...
return _19}}}
case"role":if(_11&&_43.roleIndex){var _23=_44.findAll("waiRole",_11);if(_23&&_23.length>0){_20=_23[parseInt(_43.roleIndex)];if(_23.length==parseInt(_43.roleLength)){if(this.logIsInfoEnabled("AutoTest")){this.logInfo("Locator string:"+_155+" - returning widget with matching role / index by role:"+_20,"AutoTest")}
return _20}}}
...
if(_24){this.logWarn("Locator string:"+_155+" matching by index gave "+_24+". Reliability cannot be guaranteed for matching by index if the underlying "+"application undergoes any changes.","AutoTest");return _24}}}
this.logDebug("AutoTest.getElement(): locator substring:"+_155+" parsed to fallback locator name:"+_9+", unable to find relevant child - may refer to inner element.","AutoTest")}});isc.Canvas.addMethods({getLocator:function(_50,_155){var _26,_27;if(this._generated||this.locatorParent||this.creator||this.$541){_27=this.getLocatorParent()}
if(!_27){_26=this.getLocatorRoot()}else{_26=_27.getLocator()+"/"+_27.getChildLocator(this)}
if(_50)return[_26,this.getInteriorLocator(_50,_155)].join("/");return _26},$549:["//",,'[ID="',,'"]'],getLocatorRoot:function(){if(!this.locatorRoot){if(this.$541&&this.parentElement==null){this.locatorRoot="//"+isc.Canvas.getCanvasLocatorFallbackPath("autoID",this,isc.Canvas.$tw)}else{this.$549[1]=this.getClassName();this.$549[3]=this.getID();this.locatorRoot=this.$549.join(isc.emptyString)}}
...
return this.getStandardChildLocator(_39)},checkLocatorForNativeElement:function(_67,_50){if(_50==null||_67==null)return false;return(isc.EventHandler.eventHandledNatively("mousedown",_50)&&(isc.AutoTest.getElement(_67)!=_50))},getCanvasLocatorFallbackPath:function(_9,_39,_155,_156,_157){return isc.Canvas.getCanvasLocatorFallbackPath(_9,_39,_155,_156,_157)},getAutoChildLocator:function(_39){if(this.$542){var _30=_39.getID();for(var _31 in this.$542){var _32=this.$542[_31];if(_32.contains(_30)){if(_39==this[_31])return _31;else{var _33=[];for(var i=0;i<_32.length;i++){_33[i]=window[_32[i]]}
...
if(_39==this[_34]){return _9}}}},getStandardChildLocator:function(_39){var _35=this.getNamedLocatorChildString(_39);if(_35)return _35;if(_39.masterElement==this){return this.getCanvasLocatorFallbackPath("peer",_39,this.peers)}else if(_39.parentElement==this){return this.getCanvasLocatorFallbackPath("child",_39,this.children)}else{this.logWarn("unexpected error - failed to find relationship between parent:"+this.getID()+" and child:"+_39.getID());return _39.getLocatorRoot()}},getInteriorLocator:function(_50,_155){if(_50&&this.useEventParts){var _36=this.getElementPart(_50);if(_36!=null&&_36.part!=null){return(_36.partID&&_36.partID!=isc.emptyString)?_36.part+"_"+_36.partID:_36.part}}
return isc.emptyString},getElementFromSplitLocator:function(_155){var _37=this.getChildFromLocatorSubstring(_155[0],0,_155);if(_37){_155.removeAt(0);return _37.getElementFromSplitLocator(_155)}
return this.getInnerElementFromSplitLocator(_155)},getChildFromLocatorSubstring:function(_155,_25,_156){if(_155==null||_155=="")return null;if(isc.isA.Canvas(this[_155])){return this[_155]}
if(this.namedLocatorChildren!=null){var _38=this.namedLocatorChildren.find("name",_155);if(_38!=null){var _39=this[_38.attribute];if(isc.isA.Canvas(_39))return _39;this.logWarn("Locator substring:"+_155+" remaps to attribute:"+_38.attribute+" but no canvas exists under that attribute name.","AutoTest")}}
var _40=isc.AutoTest.parseLocatorFallbackPath(_155);if(_40!=null){return this.getChildFromFallbackLocator(_155,_40)}
return null},getChildLocatorStrategy:function(_155){if(isc.AutoTest.locStrategyNames==null){isc.AutoTest.locStrategyNames={}}
var _34=isc.AutoTest.locStrategyNames[_155];if(_34==null){var _41=_155;if(this.$558[_155])_41=this.$558[_155];_34=isc.AutoTest.locStrategyNames[_155]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"By"}
return this[_34]},getChildLocatorTypeStrategy:function(_155){if(isc.AutoTest.locStrategyTypes==null){isc.AutoTest.locStrategyTypes={}}
var _34=isc.AutoTest.locStrategyTypes[_155];if(_34==null){var _41=_155;if(this.$558[_155])_41=this.$558[_155];_34=isc.AutoTest.locStrategyTypes[_155]="locate"+_41.substring(0,1).toUpperCase()+_41.substring(1)+"Type"}
return this[_34]},getChildFromFallbackLocator:function(_155,_40){var _42=_40.name,_43=_40.config;var _44=this.getFallbackLocatorCandidates(_42);if(_44&&_44.length>0){var _45=this.getChildLocatorStrategy(_42);if(_45==null)_45="name";var _46=this.getChildLocatorTypeStrategy(_42);if(_46==null)_46="Class";var _24=isc.Canvas.getCanvasFromFallbackLocator(_155,_43,_44,_45,_46);if(_24!=null)return _24}
this.logDebug("AutoTest.getElement(): locator substring:"+_155+" parsed to fallback locator name:"+_42+", unable to find relevant child - may refer to inner element.","AutoTest")},$558:{peer:"peers",child:"children"},getFallbackLocatorCandidates:function(_9){var _44;if(this.$542!=null&&this.$542[_9]!=null){var _47=this.$542[_9];_44=[];for(var i=0;i<_47.length;i++){_44[i]=window[_47[i]]}}else if(this.$558[_9]!=null){_44=this[this.$558[_9]]}else if(this[_9]&&isc.isAn.Array(this[_9])){_44=this[_9]}
return _44},emptyLocatorArray:function(_155){return _155==null||_155.length==0||(_155.length==1&&_155[0]=="")},getInnerElementFromSplitLocator:function(_155){if(!this.emptyLocatorArray(_155)){if(_155.length==1){var _48=_155[0].split("_");var _49={part:_48[0],partID:_48[1]};var _50=this.getPartElement(_49);if(_50)return _50}}
...
if(isc.StretchImg){isc.StretchImg.addProperties({getInteriorLocator:function(_50,_155){var _62=_50,_63=this.getHandle(),_64=this.getCanvasName();while(_50&&_50!=_63&&_50.getAttribute){var _30=_50.getAttribute("name");if(_30&&_30.startsWith(_64)){return _30.substring(_64.length)}
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_62,_155])},getInnerElementFromSplitLocator:function(_155){if(!this.emptyLocatorArray(_155)&&_155.length==1){var _65=this.getImage(_155[0]);if(_65)return _65}
...
return this.Super("getChildLocator",arguments)},getItemFromSplitLocator:function(_155){var _71=_155[0],_10;if(_71.contains("[Class=")){var _72=_71.match("item\\[(.+)'\\]\\[Class=\"(.+)\"\\]");_10=_72[1].substring(6,_72[1].length-2);_71=_72[0]}
...
return _61}
return null},getInnerElementFromSplitLocator:function(_155){if(this.emptyLocatorArray(_155)){return this.getHandle()}
var _61=this.getItemFromSplitLocator(_155);if(_61!=null){_155.removeAt(0);return _61.getInnerElementFromSplitLocator(_155)}
return this.getHandle()}});isc.ContainerItem.addProperties({getItemLocator:isc.DynamicForm.getPrototype().getItemLocator,getItemFromSplitLocator:isc.DynamicForm.getPrototype().getItemFromSplitLocator,getInnerElementFromSplitLocator:function(_155){if(!this.emptyLocatorArray(_155)){var _76=this.getItemFromSplitLocator(_155);if(_76!=null){_155.removeAt(0);return _76.getInnerElementFromSplitLocator(_155)}}
return this.Super("getInnerElementFromSplitLocator",arguments)}});isc.FormItem.addProperties({getInnerElementFromSplitLocator:function(_155){if(!this.emptyLocatorArray(_155)){var _49=_155[0];if(_49=="element")return this.getDataElement();if(_49=="title")return this.form.getTitleCell(this);if(_49=="textbox")return this.$15h();if(_49=="controltable")return this.$56a();if(_49=="canvas"){if(this.canvas){_155.removeAt(0);return this.canvas.getElementFromSplitLocator(_155)}}
if(_49=="picker"){if(this.picker){_155.removeAt(0);return this.picker.getElementFromSplitLocator(_155)}}
if(_49=="pickList"){if(!this.pickList)this.makePickList(false);_155.removeAt(0);return this.pickList.getElementFromSplitLocator(_155)}
...
_90=_80+(this.$252||0);_92=_81+(this.$254||0);return[_90,_92]},getCellLocator:function(_80,_81){return"row["+_80+"]/col["+_81+"]"},getInnerElementFromSplitLocator:function(_155){if(this.emptyLocatorArray(_155))return this.getHandle();if(_155.length==2){var _79=this.getCellFromLocator(_155[0],_155[1]),_80=_79[0],_81=_79[1];if(isc.isA.Number(_80)&&isc.isA.Number(_81)){if(this.$29p())return null;return this.getTableElement(_80,_81)}}
...
if(isc.ListGrid){isc.ListGrid.addProperties({namedLocatorChildren:["header","frozenHeader","body","frozenBody",{attribute:"$286",name:"editRowForm"}]});isc.GridBody.addProperties({getInteriorLocator:function(_50,_155){if(_155){var _32=this.children;if(_32!=null&&_32.length>0){for(var i=0;i<_32.length;i++){var _37=_32[i];if(_37&&_37.eventProxy==this){var _63=_37.getHandle();if(_63!=null){var _95=_50;while(_95!=this.getHandle()&&_95!=null)
...
_99[isc.AutoTest.fallback_valueOnlyField]=_81;return _99},getChildFromLocatorSubstring:function(_155,_25,_156){if(_155=="frozenBody"||_155=="body"){if(_156.length==_25+3&&_156[_25+1].startsWith("row[")&&_156[_25+2].startsWith("col["))
{return null}}
return this.Super("getChildFromLocatorSubstring",arguments)},getInnerElementFromSplitLocator:function(_155){if(this.emptyLocatorArray(_155))return this.getHandle();var _107=_155[0];if(_155.length==3&&(_107=="body"||_107=="frozenBody")){var _108=_155[2],_109=isc.AutoTest.parseLocatorFallbackPath(_108);if(_109.name!="col"){this.logWarn("Error parsing locator:"+_155.join("")+" returning ListGrid handle");return this.getHandle()}
...
var _111=_155[1],_112=isc.AutoTest.parseLocatorFallbackPath(_111),_80=this.getRowNumFromLocatorConfig(_112.config);if(isc.isA.Number(_80)&&isc.isA.Number(_110)){if(_107.$29p())return null;return _107.getTableElement(_80,_110)}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getFieldFromColLocatorConfig:function(_155){if(_155.isCheckboxField!=null){for(var i=0;i<this.fields.length;i++){if(this.isCheckboxField(this.fields[i])){return this.fields[i]}
this.logWarn("AutoTest stored a locator for interaction with "+"checkbox field - but this grid is not showing a checkbox field - "+"recorded test may be invalid.","AutoTest");return-1}}else{var _113=this.locateColumnsBy;if(_113=="fieldName"||_113==null){var _105=_155.fieldName;if(_105!=null){return this.getField(_105)}}}},getRowNumFromLocatorConfig:function(_155){var _114=this.locateRowsBy;if(_114==null)_114="primaryKey";switch(_114){case"primaryKey":var _102=this.getDataSource();if(_102!=null){var _115=_102.getPrimaryKeyFieldName();if(_102!=null&&_155[_115]!=null){return this.findRowNum(_155)}}
case"titleField":var _104=this.getTitleField();if(_104!=null&&_155[_104]!=null){var _116=this.data;return _116.findIndex(_104,_155[_104])}
case"targetCellValue":for(var _105 in _155){if(_105==isc.AutoTest.fallback_valueOnlyField)continue;if(_155[_105]!=null){return this.data.findIndex(_105,_155[_105])}}
default:return parseInt(_155[isc.AutoTest.fallback_valueOnlyField])}}})}
...
_50=_50.parentNode}
return this.Super("getInteriorLocator",[_62])},getInnerElementFromSplitLocator:function(_155){if(this.emptyLocatorArray(_155))return this.getHandle();if(_155.length==3){if(_155[2]=="open"){if(this.$29p())return null;var _111=_155[0];var _80;if(_111.charAt(3)!="["){_80=parseInt(_111.substring(3))}else{var _112=isc.AutoTest.parseLocatorFallbackPath(_111);if(_112==null||_112.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_155.join("/"),"AutoTest")}
_80=this.grid.getRowNumFromLocatorConfig(_112.config)}
var _120=this.grid.$34l+_80,_65=this.grid.getImage(_120);if(_65)return _65}else if(_155[2]=="extra"){if(this.$29p())return null;var _111=_155[0];var _80;if(_111.charAt(3)!="["){_80=parseInt(_111.substring(3))}else{var _112=isc.AutoTest.parseLocatorFallbackPath(_111);if(_112==null||_112.name!="row"){this.logInfo("Locator appears to be click-in-open-area locator but "+"doesn't contain row/col info? returning null.\n"+_155.join("/"),"AutoTest")}
_80=this.grid.getRowNumFromLocatorConfig(_112.config)}
var _120=this.grid.$349+_80,_65=this.grid.getImage(_120);if(_65)return _65}}
return this.Super("getInnerElementFromSplitLocator",arguments)},getAutoTestLocatorCoords:function(_67,_50){var _121=this.Super("getAutoTestLocatorCoords",arguments);if(_121==null)return _121;var _122=this.grid;if(_122==null||_67.endsWith("open")||_67.endsWith("extra"))return _121;var _51=isc.Element.getElementRect(_50);var _52=_51[0];_52+=_51[2];_52-=1;var _54=_51[1],_55=_51[3];_54+=Math.floor(_55/ 2);return[_52,_54]}})}
if(isc.TabSet){isc.TabSet.addProperties({containsLocatorChild:function(_39){if(this.Super("containsLocatorChild",arguments))return true;if(this.getTabNumber(_39)!=-1)return true;return false},getStandardChildLocator:function(_39){var _123=this.getTabNumber(_39);if(_123!=-1){var _124=this.getTabObject(_123);var _125={};if(_124.ID!=null)_125.ID=_124.ID;if(_124.title!=null)_125.title=_124.title;_125.index=_123;return isc.AutoTest.createLocatorFallbackPath("tab",_125)}
return this.Super("getStandardChildLocator",arguments)},getChildFromLocatorSubstring:function(_155){if(_155&&_155.startsWith("tab[")){var _126=isc.AutoTest.parseLocatorFallbackPath(_155),_43=_126.config;if(_43.ID!=null){return this.getTab(_43.ID)}
var _127=this.locateTabsBy;if(_127==null)_127="title";if(_43.title&&_127=="title"){var _123=this.tabs.findIndex("title",_43.title);return this.getTab(_123)}
return this.getTab(parseInt(_43.index))}
return this.Super("getChildFromLocatorSubstring",arguments)}})}
if(isc.StatefulCanvas){isc.StatefulCanvas.addProperties({getInnerElementFromSplitLocator:function(_155){if(!this.emptyLocatorArray(_155)&&this.label){return this.label.getInnerElementFromSplitLocator(_155)}
return this.Super("getInnerElementFromSplitLocator",arguments)}})}
if(isc.DateChooser){isc.DateChooser.addMethods({getInteriorLocator:function(_50){var _63=this.getHandle();if(!_63||!_50)return"";var _128=_50.$73l;if(_128!=null&&_128!="")return _128;return _50.$73l=this.$73m(_50,_63)},$73m:function(_50,_63){var _129=_50;while(_129&&_129!=null){if(_129==_63){_129=null;break}
if(_129.tagName&&_129.tagName.toLowerCase()=="td"){break}
_129=_129.parentElement}
if(_129==null)return"";var _130=_63.childNodes,_131=[];for(var i=0;i<_130.length;i++){if(!_130[i].tagName||_130[i].tagName.toLowerCase()!="table"){continue}
_131[_131.length]=_130[i]}
var _132=_131.length==2?_131[0]:null,_133=_131.length==2?_131[1]:_131[0];if(_132!=null&&_129.offsetParent==_132){var _134=_129.onclick,_135=_134?_134.toString():null;if(!_135)return"";if(_135.contains("showPrevYear")){return"prevYearButton"}else if(_135.contains("showNextYear")){return"nextYearButton"}else if(_135.contains("showPrevMonth")){return"prevMonthButton"}else if(_135.contains("showNextMonth")){return"nextMonthButton"}else if(_135.contains("showMonthMenu")){return"monthMenuButton"}else if(_135.contains("showYearMenu")){return"yearMenuButton"}
return""}else if(_133!=null&&_129.offsetParent==_133){var _134=_129.onclick,_135=_134?_134.toString():null;if(!_135)return"";if(_135.contains("cancelClick"))return"cancelButton";else if(_135.contains("todayClick"))return"todayButton";else{var _136=_135.match("dateClick\\(\(.*\)\\)");if(_136&&_136[1]){var _137=_136[1].split(",");for(var i=0;i<_137.length;i++){_137[i]=_137[i].trim()}
return _137.join("/")}}}
return""},getInnerElementFromSplitLocator:function(_155){if(this.emptyLocatorArray(_155))return this.getHandle();var _63=this.getHandle();if(_63==null)return;var _138=(_155.length==3);if(!_138){var _58=_155[0];if(_58=="")return _63;var _139=(_58=="todayButton"),_140=!_139?(_58=="cancelButton"):false;var _130=_63.childNodes;if(_139||_140){if(_139&&!this.showTodayButton){this.logWarn("DateChooser attempting to locate element for "+"'todayButton' but showTodayButton is false. Returning handle.","AutoTest");return _63}
if(_140&&!this.showCancelButton){this.logWarn("DateChooser attempting to locate element for "+"'cancelButton' but showCancelButton is false. Returning handle.","AutoTest");return _63}
var _133;for(var i=_130.length-1;i>=0;i--){if(_130[i].tagName&&_130[i].tagName.toLowerCase()=="table")
{_133=_130[i];break}}
var _141=_133.rows[_133.rows.length-1],_91=_141.cells;for(var i=0;i<_91.length;i++){if(this.getInteriorLocator(_91[i])==_58){return _91[i]}}}else{if(!this.showHeader){this.logWarn("DateChooser attempting to locate element for "+_155+" but this.showHeader is false so this element will not be present. "+"Returning handle.","AutoTest");return _63}
var _132
for(var i=0;i<_130.length;i++){if(_130[i].tagName&&_130[i].tagName.toLowerCase()=="table")
{_132=_130[i];break}}
var _85=_132.rows[0],_91=_85.cells;for(var i=0;i<_91.length;i++){if(this.getInteriorLocator(_91[i])==_58){return _91[i]}}}}else{var _142=_155[0],_143=_155[1],_144=_155[2];if((_142==this.year)&&(this.month==_143||this.month==_143+1||this.month==_143-1))
{var _145=new Date(_142,_143,_144),_146=_145.getDay();if(this.showWeekends||!Date.getWeekendDays().contains(_146)){var _147=new Date(this.year,this.month,1);var _148=_147.getDay(),_149=_148+this.firstDayOfWeek-
(_148<this.firstDayOfWeek?7:0);_147.setDate(_147.getDate()-_149);if(Date.compareDates(_145,_147)!=1){var _150=new Date(this.year,this.month+1,1);_150.setTime(_150.getTime()-86400000);var _151=_150.getDay(),_152=this.firstDayOfWeek+6;if(_152>6)_152-=7;var _153=_152>_151?_152-_151:_152+7-_151;if(_153!=0){_150.setTime(_150.getTime()+(86400000*_153))}
if(Date.compareDates(_145,_150)!=-1){var _80=Math.floor(((parseInt(_144)+_149)/7))
_80+=1;var _154=this.firstDayOfWeek;if(!this.showWeekends){while(Date.getWeekendDays().contains(_154)){_154+=1;if(_154==7)_154=0}}
var _81=_145.getDay()-_154;if(_81<0)_81+=7;var _130=_63.childNodes,_133;for(var i=_130.length-1;i>=0;i--){if(_130[i].tagName&&_130[i].tagName.toLowerCase()=="table")
{_133=_130[i];break}}
if(_133)return _133.rows[_80].cells[_81]}else{this.logInfo("DateChooser Passed ID for a date after end. "+"end date:"+[_150.getFullYear(),_150.getMonth(),_150.getDay()]+" vs:"+[_142,_143,_144],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a date before start date. "+"startDate:"+[_147.getFullYear(),_147.getMonth(),_147.getDay()]+" vs:"+[_142,_143,_144],"AutoTest")}}else{this.logInfo("DateChooser Passed ID for a weekend - not showing weekends","AutoTest")}}else{this.logInfo("DateChooser passed ID for the wrong year or month - passed:"+_155+", showing:"+[this.year,this.month],"AutoTest")}
this.logWarn("DateChooser - passed inner locator for date ("+_155.join("/")+") -- not currently showing this date.","AutoTest")}
this.logWarn("DateChooser, unable to find element for inner locator:"+_155+" returning handle");return _63}})}}
