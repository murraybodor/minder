...
);isc.B._maxIndex=isc.C+218;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$77j="section";isc.A.$77k="SectionItem";isc.A.$77l="button";isc.A.$77m="ButtonItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function isc_c_DynamicForm_getEditorType(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
...
this.$751=this.pickList.data.find(this.getValueFieldName(),this._value)}
return this.$751}
...
{return true}}
return false}
);isc.evalBoundary;isc.B.push(isc.A.getDefaultValue=function isc_FormItem_getDefaultValue(){if(this.defaultDynamicValue){this.convertToMethod("defaultDynamicValue");var _1=this,_2=this.form,_3=this.form.getValues();return this.defaultDynamicValue(_1,_2,_3)}
...
,isc.A.getCriteriaFieldName=function isc_FormItem_getCriteriaFieldName(){return this.criteriaField||this.getFieldName()}
...
_2+=" - returning zero.";this.form.logWarn(_2);return 0}
return this.$18k(_1)}
);isc.evalBoundary;isc.B.push(isc.A.$18k=function isc_FormItem__getElementLeft(_1){var _2=_1.offsetParent,_3=this.containerWidget.getHandle(),_4=_3.offsetParent,_5=isc.Element.getOffsetLeft(_1);while(_2&&_2!=_3&&_2!=_4){_5+=isc.Element.getOffsetLeft(_2)
...
if(isc.Browser.isSafari){if(this.browserAutoCapitalize==false){_4[_4.length]=" autocapitalize=off"}
if(this.browserAutoCorrect==false){_4[_4.length]=" autocorrect=off"}
if(this.browserInputType!=null){var _8=this.browserInputTypeMap[this.browserInputType];if(_8==null)_8=this.browserInputType;_4[_4.length]=" type='"+_8+"'"}}
...
_4[_4.length]=this.getElementStyleHTML();var _9=this.$154();if(_9!=null){var _10=_4.length;_4[_10]=this.$14f;isc.$bk(_4,_9,_10+1,5)}
if(this.showTitle==false&&this.accessKey!=null){_4[_4.length]=this.$14e;_4[_4.length]=this.accessKey}
_4[_4.length]=this.$oa;var _11=_4.join(isc.emptyString);_4.length=8;return _11}
...
);isc.B._maxIndex=isc.C+63;isc.ValuesManager.registerStringMethods({handleHiddenValidationErrors:"errors"});if(isc.Window){isc.ClassFactory.defineClass("ColorPicker",isc.Window);isc.A=isc.ColorPicker;isc.A.MORE_BUTTON_TITLE="More >>";isc.A.LESS_BUTTON_TITLE="<< Less";isc.A=isc.ColorPicker;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSharedColorPicker=function isc_c_ColorPicker_getSharedColorPicker(_1,_2){if(!isc.isA.ColorPicker(this.$56b)){this.$56b=isc.ColorPicker.create(_1)}
...
,isc.A.setValue=function isc_DateRangeItem_setValue(_1){var _2=_1?_1.start:null,_3=_1?_1.end:null,_4=isc.RelativeDateItem;if(!this.allowRelativeDates&&_4.isRelativeDate(_2))this.setFromDate(null);else this.setFromDate(_2);if(!this.allowRelativeDates&&_4.isRelativeDate(_3))this.setToDate(null);else this.setToDate(_3)}
...
,isc.A.setValue=function isc_MiniDateRangeItem_setValue(_1){if(_1!=null){if(isc.DataSource.isAdvancedCriteria(_1)){var _2={};for(var i=0;i<_1.criteria.length;i++){var _4=_1.criteria[i];if(_4.operator=="greaterThan"||_4.operator=="greaterOrEqual")
...
this.rangeItem.setFromDate(this.fromDate);this.rangeItem.setToDate(this.toDate);var _5=this.mapValueToDisplay(_1)||"";this.setElementValue(_5,_1)}
